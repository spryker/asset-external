 ...
 */
class AssetExternalUpdateListenerPlugin extends AbstractPlugin implements EventHandlerInterface
{
    /**
     * {@inheritDoc}
     *
     * @api
     *
     * @param \Generated\Shared\Transfer\AssetUpdatedMessageTransfer $transfer
    ...
    {
        $this->getFacade()->updateAsset($transfer);
    }
}
