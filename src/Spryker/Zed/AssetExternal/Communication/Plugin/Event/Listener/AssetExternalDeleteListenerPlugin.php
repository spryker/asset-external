 ...
 */
class AssetExternalDeleteListenerPlugin extends AbstractPlugin implements EventHandlerInterface
{
    /**
     * {@inheritDoc}
     *
     * @api
     *
     * @param \Generated\Shared\Transfer\AssetDeletedMessageTransfer $transfer
    ...
    {
        $this->getFacade()->deleteAsset($transfer);
    }
}
